...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Python no es solo una serpiente</h1>", unsafe_allow_html=True)
    ...
    col1.image("fotoperfil.jpg", caption='Lilian Venegas', width=300)
    ...
    st.markdown("<h2 style='text-align: center;'>Aprendiendo en el curso</h2>", unsafe_allow_html=True)
    ...
    st.video("https://youtu.be/cROMbfgRjNc")
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://youtu.be/cROMbfgRjNc' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Graficando en el curso</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Gráfico de barras verticales de Psych2Go', 'Nube de palabras de canciones', 'Mapa películas']
    ...
    if grafico_seleccionado == 'Gráfico de barras verticales de Psych2Go':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El primer gráfico es un gráfico de barras. Este nos permite representar y contabilizar las frecuencias de las temáticas de los videos más vistos del canal “Psych2Go” en la plataforma de Youtube. Por ello, podemos decir que las temáticas relacionadas a la ansiedad y el estrés son las más vistas por el público del canal.</div>", unsafe_allow_html=True)
        st.image("g1_barras.png", caption='Gráfico de barras verticales de Psych2Go', width=500)
        pass
    elif grafico_seleccionado == 'Nube de palabras de canciones':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>En esta segunda gráfica se trata de una nube de palabras. En ella se retratan las palabras más repetidas en la lírica de dos canciones. Por ello, es posible asegurar que las palabras “better”, “got” y “go” son las palabras más representativas.</div>", unsafe_allow_html=True)
        st.image("g2_nube_palabras_pc2pregunta4.png", caption='Nube de palabras de canciones', width=500)
        pass
    elif grafico_seleccionado == 'Mapa películas':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>En este mapa se buscaba representar las distintas locaciones en las que se grabaron mis películas favoritas. En la gráfica podemos visualizar un gusto globalizado, pues se muestran marcadores en distintos países y continentes del mundo.</div>", unsafe_allow_html=True)
        # Si "mapa_cusco.html" es un archivo HTML (no una imagen), debes mostrarlo con st.components.v1.html
        import streamlit.components.v1 as components
        with open("mi_mapa.html", "r", encoding="utf-8") as f:
            html_content = f.read()
